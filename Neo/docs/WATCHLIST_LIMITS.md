...
2. `ht_insert` всех Domain/Full-доменов в основную таблицу (`match_subs=1`, точные дубликаты игнорируются)

**Пиковая память на тег** ≈ `N доменов × ~50 байт` (исходный массив) + чанки основной таблицы.
