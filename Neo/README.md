...
Всего **29 параметров** конфигурации, сгруппированных по назначению:
...
- Раздел **«DANGER ZONE»** — редактирование параметров маршрутизации и L7 в `hrneo.conf` через формы с подсказками (токен доступа RCI вынесен в «Настройки»)
